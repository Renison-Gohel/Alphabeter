...
def parse_and_run():
    ...
    ### Login module
    parser_login = subparsers.add_parser('login', help="Authenticate Alphabeter to Google.", formatter_class=RichHelpFormatter)
...
def process_args(args: argparse.Namespace):
    ...
    match args.module:
        ...
        case "spiderdal":
            ...
            from alphabeter.modules import spiderdal
