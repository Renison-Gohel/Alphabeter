...
from alphabeter.apis.identitytoolkit import IdentityToolkitHttp
...
async def project_nb_from_key(as_client: httpx.AsyncClient, alphabeter_creds: AlphabeterCreds, api_key: str, fallback=True) -> str|None:
    identitytoolkit_api = IdentityToolkitHttp(alphabeter_creds)
