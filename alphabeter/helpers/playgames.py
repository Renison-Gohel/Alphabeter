...
from alphabeter.apis.playgames import PlayGames
from alphabeter.apis.playgateway import PlayGatewayPaGrpc
from alphabeter.parsers.playgames import Player, PlayerProfile
from alphabeter.parsers.playgateway import PlayerSearchResult
from alphabeter.objects.utils import TMPrinter
...
async def get_player(alphabeter_creds: AlphabeterCreds, as_client: httpx.AsyncClient, player_id: str):
    playgames = PlayGames(alphabeter_creds)
    ...
    playgateway_pa = PlayGatewayPaGrpc(alphabeter_creds)
...
async def search_player(alphabeter_creds: AlphabeterCreds, as_client: httpx.AsyncClient, query: str) -> List[PlayerSearchResult]:
    playgateway_pa = PlayGatewayPaGrpc(alphabeter_creds)
