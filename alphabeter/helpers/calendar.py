...
from alphabeter.apis.calendar import CalendarHttp


async def fetch_all(alphabeter_creds: AlphabeterCreds, as_client: httpx.AsyncClient, email_address: str) -> Tuple[Boolean, Calendar, CalendarEvents]:
    calendar_api = CalendarHttp(alphabeter_creds)
