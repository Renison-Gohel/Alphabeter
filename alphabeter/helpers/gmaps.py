...
from alphabeter.objects.base import *
from alphabeter.helpers.utils import *
from alphabeter.objects.utils import *
from alphabeter.helpers.knowledge import get_gmaps_type_translation
...
def output(err: str, stats: Dict[str, int], gaia_id: str):
    ...
    # I removed the costs calculation because of a Google update : https://github.com/RC/Alphabeter/issues/529
    ...
    #     if unknown_trads:
    #         print(f"\n⚠️ The following gmaps types haven't been found in Alphabeter\'s knowledge.")
    #         for type in unknown_trads:
    #             print(f"- {type}")
    #         print("Please open an issue on the Alphabeter Github or submit a PR to add it !")
