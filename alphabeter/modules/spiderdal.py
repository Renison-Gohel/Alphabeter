...
from alphabeter.apis.digitalassetslinks import DigitalAssetsLinksHttp
from alphabeter.helpers.playstore import app_exists
...
async def main(url: str, package: str, fingerprint: str, strict: bool, json_file: Path):
    ...
    alphabeter_creds.load_creds()

    as_client = get_httpx_client()
    digitalassetslink = DigitalAssetsLinksHttp(alphabeter_creds)
    ...
    if json_file:
        ...
        with open(json_file, "w", encoding="utf-8") as f:
            f.write(json.dumps({
                "sites": sites,
                "packages": pkgs
            }, cls=AlphabeterEncoder, indent=4))
