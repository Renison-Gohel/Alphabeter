...
from alphabeter.objects.base import DriveExtractedUser, AlphabeterCreds
from alphabeter.apis.drive import DriveHttp
from alphabeter.apis.clientauthconfig import ClientAuthConfigHttp
from alphabeter import globals as gb
from alphabeter.helpers import auth
from alphabeter.helpers.drive import get_comments_from_file, get_users_from_file
from alphabeter.knowledge import drive as drive_knownledge
...
async def hunt(as_client: httpx.AsyncClient, file_id: str, json_file: bool=Path):
    ...
    drive = DriveHttp(alphabeter_creds)
    ...
    if file.source_app_id:
        ...
        cac = ClientAuthConfigHttp(alphabeter_creds)
